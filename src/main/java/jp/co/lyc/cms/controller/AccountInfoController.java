...
public class AccountInfoController extends BaseController {
	...
	public HashMap<String, Object> init(@RequestBody AccountInfoModel onloadMol) {
		...
		List<AccountInfoModel> accountInfoMod = new ArrayList<AccountInfoModel>();
	 ...
	 * データを取得
	 * 
	 * @param employeeOrCustomerNo * @param accountBelongsStatus
	 * @return
	 */
	public List<AccountInfoModel> getBankBranchInfo(String employeeOrCustomerNo) {
		logger.info("BankInfoController.selectBankInfo:" + "検索開始");
		List<AccountInfoModel> resultMod = bankInfoSer.selectAccountInfo(employeeOrCustomerNo);
